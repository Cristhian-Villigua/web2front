...
const EditEmpleado: React.FC = () => {
  ...
  useEffect(() => {
    ...
    Api.get(`/empleado/usuarios/${id}`, {
      ...
      .then((response) => {
        const empleado: Empleado = response.data.usuario;
        setForm({
          nombres: empleado.nombres || "",
          apellidos: empleado.apellidos || "",
          cedula: empleado.cedula || "",
          celular: empleado.celular || "",
          dirrecion: empleado.dirrecion || "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await Api.put(`/empleado/usuarios/${id}`, form, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
      ...
      Swal.fire({
        icon: "error",
        title: "Error",
        text: "Error al actualizar al empleado.",
      });
    }
  };
  ...
  return (
    <AdminLayout>
      <div className="row">
        <h1>Editar Empleado: {form.nombres} {form.apellidos}</h1>
      </div>
      <hr />
      <div className="row">
